      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="flex w-48 flex-col border-r border-gray-200 bg-white">
          <div className="flex items-center justify-between px-3 py-2 border-b border-gray-100">
            <span className="text-xs font-semibold uppercase tracking-wide text-gray-400">Seiten</span>
            <button
              onClick={() => setShowNewPageDialog(true)}
              className="rounded p-1 text-gray-400 transition-colors hover:bg-violet-50 hover:text-violet-600"
              title="Neue Seite"
            >
          ...
          <nav className="flex-1 overflow-y-auto p-2 space-y-1">
            {pages.map((page, index) => (
              ...
              >
                <span className="truncate">{page.title || `Seite ${index + 1}`}</span>
                {isTeacher && pages.length > 1 && (
                  <button
                    ...
                    className="hidden rounded p-0.5 text-gray-400 transition-colors hover:bg-red-50 hover:text-red-500 group-hover:block"
                    title="Seite löschen"
                  >
