...
const LassoSelectIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 12c0-4 4-8 8-8s8 4 8 8-4 8-8 8" strokeDasharray="4 2" />
...
const TOOL_ITEMS: { tool: ToolType; label: string; icon: React.ComponentType }[] = [
  ...
  { tool: "rect-select", label: "KI Rechteck", icon: RectSelectIcon },
  { tool: "lasso-select", label: "KI Lasso", icon: LassoSelectIcon },
];
